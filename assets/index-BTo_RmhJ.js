...
var best_index : i32 = 0;`,`if (${i.getByIndices("input_indices")} ${t.selectLastIndex>0?">=":">"} value) {
    ...
    `,Nc=(e,t,r,i,n,s,a,o)=>{let u=je(a?1:s),d=64,c=s/u;c<d&&(d=32);let f=Math.ceil(s/u/d),m=[{type:12,data:t},{type:12,data:r},{type:12,data:i},{type:12,data:n},{type:12,data:c},{type:12,data:f}],y=Je(e.dataType,u),_=lt(1,u),w=["type"];a&&w.push("type"),o&&w.push("type");let T=v=>{let b=se("x",e.dataType,e.dims,u),C=[b],S=a?P("seq_lens",a.dataType,a.dims):void 0;S&&C.push(S);let I=o?P("total_sequence_length_input",o.dataType,o.dims):void 0;I&&C.push(I);let z=lt(e.dataType),A=[{name:"batch_size",type:"u32"},{name:"num_heads",type:"u32"},{name:"past_sequence_length",type:"u32"},{name:"sequence_length",type:"u32"},{name:"total_sequence_length",type:"u32"},{name:"elements_per_thread",type:"u32"}];return`
  ...
  }`};return{name:"AttentionProbs",shaderCache:{hint:`${T};${n!==void 0};${i!==void 0};${e}`,inputDependencies:z},getRunData:()=>({outputs:A,dispatchGroup:C,programUniforms:S}),getShaderSource:x}},Pc=(e,t,r,i,n,s,a=void 0,o=void 0)=>{let u=s+n.kvSequenceLength,d=n.nReps?n.nReps:1,c=n.vHiddenSize*d,f=e>1&&i,m=n.kvNumHeads?n.kvNumHeads:n.numHeads,y=f?[n.batchSize,m,u,n.headSize]:void 0,_=[n.batchSize,n.sequenceLength,c],w=12,T={x:Math.ceil(n.vHeadSize/w),y:Math.ceil(n.sequenceLength/w),z:n.batchSize*n.numHeads},v=[{type:12,data:n.sequenceLength},{type:12,data:u},{type:12,data:n.vHeadSize},{type:12,data:n.numHeads},{type:12,data:n.headSize},{type:12,data:c},{type:12,data:s},{type:12,data:n.kvSequenceLength},{type:12,data:d}],b=f&&i&&B.size(i.dims)>0,C=["type","type"];b&&C.push("type"),a&&C.push("type"),o&&C.push("type");let S=[{dims:_,dataType:t.dataType,gpuDataType:0}];f&&S.push({dims:y,dataType:t.dataType,gpuDataType:0});let I=z=>{let A=P("probs",t.dataType,t.dims),x=P("v",r.dataType,r.dims),W=[A,x];b&&W.push(P("past_value",i.dataType,i.dims));let G=a?P("seq_lens",a.dataType,a.dims):void 0;a&&W.push(G);let ue=o?P("total_sequence_length_input",o.dataType,o.dims):void 0;o&&W.push(ue);let re=[se("output",t.dataType,_)];f&&re.push(se("present_value",t.dataType,y));let ae=[{name:"M",type:"u32"},{name:"K",type:"u32"},{name:"N",type:"u32"},{name:"num_heads",type:"u32"},{name:"head_size",type:"u32"},{name:"v_hidden_size",type:"u32"},{name:"past_sequence_length",type:"u32"},{name:"kv_sequence_length",type:"u32"},{name:"n_reps",type:"u32"}];return`
  const TILE_SIZE = ${w}u;
  var<workgroup> tileQ: array<${A.type.value}, ${w*w}>;
  var<workgroup> tileV: array<${A.type.value}, ${w*w}>;
  ${z.registerUniforms(ae).declareVariables(...W,...re)}
  ${z.mainStart([w,w,1])}
   let headIdx = workgroup_id.z % uniforms.num_heads;
   let batchIdx = workgroup_id.z / uniforms.num_heads;
  ...
  }`},Ae=(e,t,r,i,n,s=e.dataType,a,o)=>{let u=[{type:12,data:Math.ceil(B.size(e.dims)/4)}];return a&&u.push(...a),{name:t,shaderCache:{hint:n,inputDependencies:["type"]},getShaderSource:d=>Gc(d,B.size(e.dims),e.dataType,s,r,i,o),getRunData:d=>({outputs:[{dims:e.dims,dataType:s}],dispatchGroup:{x:Math.ceil(B.size(d[0].dims)/64/4)},programUniforms:u})}},kg=e=>{e.compute(Ae(e.inputs[0],"Abs","abs"))},zg=e=>{e.compute(Ae(e.inputs[0],"Acos","acos"))},Ag=e=>{e.compute(Ae(e.inputs[0],"Acosh","acosh"))},Og=e=>{e.compute(Ae(e.inputs[0],"Asin","asin"))},Rg=e=>{e.compute(Ae(e.inputs[0],"Asinh","asinh"))},Mg=e=>{e.compute(Ae(e.inputs[0],"Atan","atan"))},Bg=e=>{e.compute(Ae(e.inputs[0],"Atanh","atanh"))},Ng=e=>Oe(e),Dg=(e,t)=>{let r;switch(t.to){case 10:r="vec4<f16>";break;case 1:r="vec4<f32>";break;case 12:r="vec4<u32>";break;case 6:r="vec4<i32>";break;case 9:r="vec4<bool>";break;default:throw new RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${t.to}`)}e.compute(Ae(e.inputs[0],"Cast",r,void 0,t.cacheKey,t.to))},Fc=e=>{let t,r,i=e.length>=2&&e[1].data!==0,n=e.length>=3&&e[2].data!==0;switch(e[0].dataType){case 1:t=i?e[1].getFloat32Array()[0]:-34028234663852886e22,r=n?e[2].getFloat32Array()[0]:34028234663852886e22;break;case 10:t=i?e[1].getUint16Array()[0]:64511,r=n?e[2].getUint16Array()[0]:31743;break;default:throw new Error("Unsupport data type")}return Oe({min:t,max:r})},Pg=(e,t)=>{let r=t||Fc(e.inputs),i=lt(e.inputs[0].dataType);e.compute(Ae(e.inputs[0],"Clip",n=>`clamp(${n}, vec4<${i}>(uniforms.min), vec4<${i}>(uniforms.max))`,void 0,r.cacheKey,void 0,[{type:e.inputs[0].dataType,data:r.min},{type:e.inputs[0].dataType,data:r.max}],[{name:"min",type:i},{name:"max",type:i}]),{inputs:[0]})},Ug=e=>{e.compute(Ae(e.inputs[0],"Ceil","ceil"))},Lg=e=>{e.compute(Ae(e.inputs[0],"Cos","cos"))},Wg=e=>{e.compute(Ae(e.inputs[0],"Cosh","cosh"))},qi=e=>Oe(e),qg=(e,t)=>{let r=lt(e.inputs[0].dataType);e.compute(Ae(e.inputs[0],"Elu",i=>`elu_vf32(${i})`,`
...
}`,Vg=e=>{let t=lt(e.inputs[0].dataType);e.compute(Ae(e.inputs[0],"Erf",r=>`erf_vf32(${r})`,jn(t)))},Hg=e=>{e.compute(Ae(e.inputs[0],"Exp","exp"))},Gg=e=>{e.compute(Ae(e.inputs[0],"Floor","floor"))},Fg=e=>{let t=lt(e.inputs[0].dataType);e.compute(Ae(e.inputs[0],"Gelu",r=>`0.5 * ${r} * (1.0 + erf_vf32(${r} * 0.7071067811865475))`,jn(t)))},jg=(e,t)=>{let r=lt(e.inputs[0].dataType);e.compute(Ae(e.inputs[0],"LeakyRelu",i=>`select(leaky_relu_alpha_ * ${i}, ${i}, ${i} >= vec4<${r}>(0.0))`,`const leaky_relu_alpha_ = ${r}(${t.alpha});`,t.cacheKey))},Kg=e=>{e.compute(Ae(e.inputs[0],"Not",t=>`!${t}`))},Qg=e=>{e.compute(Ae(e.inputs[0],"Neg",t=>`-${t}`))},Zg=e=>{e.compute(Ae(e.inputs[0],"Reciprocal",t=>`1.0/${t}`))},Yg=e=>{let t=lt(e.inputs[0].dataType);e.compute(Ae(e.inputs[0],"Relu",r=>`select(vec4<${t}>(0.0), ${r}, ${r} > vec4<${t}>(0.0))`))},Xg=e=>{e.compute(Ae(e.inputs[0],"Sigmoid",t=>`(1.0 / (1.0 + exp(-${t})))`))},Jg=e=>Oe(e),ey=(e,t)=>{let r=lt(e.inputs[0].dataType);e.compute(Ae(e.inputs[0],"HardSigmoid",i=>`max(vec4<${r}>(0.0), min(vec4<${r}>(1.0), ${t.alpha} * ${i} + vec4<${r}>(${t.beta})))`,void 0,t.cacheKey))},ty=e=>{e.compute(Ae(e.inputs[0],"Sin","sin"))},ry=e=>{e.compute(Ae(e.inputs[0],"Sinh","sinh"))},iy=e=>{e.compute(Ae(e.inputs[0],"Sqrt","sqrt"))},ny=e=>{e.compute(Ae(e.inputs[0],"Tan","tan"))},ga=e=>`sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`,sy=e=>{e.compute(Ae(e.inputs[0],"Tanh",ga))},lo=(e="f32")=>`
...
`,co=e=>`(fast_gelu_a + fast_gelu_a * tanh_v(${e} * (fast_gelu_c * ${e} * ${e} + fast_gelu_b))) * ${e}`,ay=e=>{let t=lt(e.inputs[0].dataType);e.compute(Ae(e.inputs[0],"FastGelu",co,lo(t),void 0,e.inputs[0].dataType))},oy=(e,t)=>{let r=lt(e.inputs[0].dataType);return e.compute(Ae(e.inputs[0],"ThresholdedRelu",i=>`select(vec4<${r}>(0.0), ${i}, ${i} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${r}>(${t.alpha});`,t.cacheKey)),0},uy=e=>{e.compute(Ae(e.inputs[0],"Log","log"))},jc=(e,t)=>`
...
`,Kc=e=>`quick_gelu_impl(${e})`,ly=(e,t)=>{let r=lt(e.inputs[0].dataType);e.compute(Ae(e.inputs[0],"QuickGelu",Kc,jc(r,t.alpha),t.cacheKey,e.inputs[0].dataType))}}),Qc,Zc,dy,a1=j(()=>{ge(),_e(),tu(),Qc=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Zc=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let r=P("input",e[0].dataType,e[0].dims,4),i=P("bias",e[0].dataType,[e[0].dims[2]],4),n=se("output",e[0].dataType,t,4),s=B.size(t)/4,a=Je(e[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)}}),getShaderSource:o=>`
  ...
  ${o.mainStart()}
    ...
    ${n.setByOffset("global_idx","valueLeft * geluRight")}
          ...
          `}else v=_.setByOffset("global_idx",y(w.getByOffset("global_idx"),T.getByOffset("global_idx")));else{if(!s)throw new Error("no necessary to use scalar implementation for element-wise binary op implementation.");let b=(C,S,I="")=>{let z=`aData[indexA${S}][componentA${S}]`,A=`bData[indexB${S}][componentB${S}]`;return`
...
`},nu=(e,t,r,i,n=!1,s)=>{let a=e[0].dims,o=e[1].dims,u=a[a.length-2],d=o[o.length-1],c=a[a.length-1],f=je(d),m=je(c),y=je(u),_=B.size(r)/f/y,w=e.length>2,T=i?i.slice(0,-2):r.slice(0,-2),v=[B.size(T),u,d],b=[{type:12,data:_},{type:12,data:u},{type:12,data:d},{type:12,data:c}];ei(t,b),b.push(...de(T,a,o)),w&&b.push(...de(e[2].dims)),b.push(...de(v));let C=S=>{let I=Xo("batch_dims",e[0].dataType,T.length),z=P("a",e[0].dataType,a.length,m),A=P("b",e[1].dataType,o.length,f),x=se("output",e[0].dataType,v.length,f),W=Je(x.type.tensor),G=Jr(t,x.type.value,W),ue=[z,A],re="";if(w){let L=n?f:1;ue.push(P("bias",e[2].dataType,e[2].dims.length,L)),re=`${n?`value += bias[col / ${L}];`:`value += ${x.type.value}(bias[row + i]);`}`}let ae=[{name:"output_size",type:"u32"},{name:"M",type:"u32"},{name:"N",type:"u32"},{name:"K",type:"u32"}];ti(t,ae);let N=()=>{let L=`var a_data: ${z.type.value};`;for(let Q=0;Q<m;Q++)L+=`
            ...
            values[${Q}] = fma(${A.type.value}(a_data${m===1?"":`[${te}]`}), b_data${te}, values[${Q}]);
`}return L};return`
  ...
  ${S.mainStart()}
    ...
    ${Xi("a_indices",z,z.rank-2,I.rank,"batch_indices")}
    ${z.indicesSet("a_indices",z.rank-2,0)}
    ${z.indicesSet("a_indices",z.rank-1,0)}
    let a_offset = ${z.indicesToOffset("a_indices")};

    var b_indices: ${A.type.indices};
    ${Xi("b_indices",A,A.rank-2,I.rank,"batch_indices")}
...
`},ap=(e,t,r,i,n=!1)=>{let[s,a,o,u]=i,d=Je(i[0].type.tensor);return`
    ...
    `},ss=(e,t,r,i,n=!1,s)=>{let a=e[0].dims,o=e[1].dims,u=a.slice(0,-2),d=o.slice(0,-2),c=i?i.slice(0,-2):r.slice(0,-2),f=B.size(c),m=a[a.length-2],y=a[a.length-1],_=o[o.length-1],w=y%4===0&&_%4===0,T=m<=8?[4,1,1]:[4,4,1],v=[8,8,1],b=[Math.ceil(_/v[0]/T[0]),Math.ceil(m/v[1]/T[1]),Math.ceil(f/v[2]/T[2])],C=w?4:1,S=[...u,m,y/C],I=S.length,z=[...d,y,_/C],A=z.length,x=[f,m,_/C],W=[{type:6,data:m},{type:6,data:_},{type:6,data:y}];ei(t,W),W.push(...de(c,S,z));let G=["rank","rank"],ue=e.length>2;ue&&(W.push(...de(e[2].dims)),G.push("rank")),W.push(...de(x));let re=ae=>{let N=c.length,L=Xo("batchDims",e[0].dataType,N,1),Q=Je(e[0].dataType),te=P("a",e[0].dataType,I,C),Z=P("b",e[1].dataType,A,C),le=se("result",e[0].dataType,x.length,C),Te=[te,Z];if(ue){let at=n?C:1;Te.push(P("bias",e[2].dataType,e[2].dims.length,at))}let U=[{name:"dim_a_outer",type:"i32"},{name:"dim_b_outer",type:"i32"},{name:"dim_inner",type:"i32"}];ti(t,U);let K=Je(le.type.tensor),pe=Jr(t,le.type.value,K),$e=ap(C,ue,pe,[L,te,Z,le],n);return`
  ...
  ${w?po(T,v,Q,L):fo(T,v,Q,L)}
    ...
    return ${tt(o,d)}(0.0);`,I=tt(u,d),z=tt(e?a:o,d),A=tt(e?o:a,d),x=Jr(s,I,d);return`
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${I}) {
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${w?`vec4<${le}>`:le}) {
        ...
        ${w?po(C,b,le,void 0,!d,x):fo(C,b,le,void 0,!d,x,!1,void 0,o)}`};return{name:"Conv2DMatMul",shaderCache:{hint:`${t.cacheKey};${I};${w};${W};${G};${ue};${z};${A};${x}`,inputDependencies:N},getRunData:()=>({outputs:[{dims:u?u(r):r,dataType:e[0].dataType}],dispatchGroup:{x:S[0],y:S[1],z:S[2]},programUniforms:ae}),getShaderSource:L}}}),up,_a,Ri,lp,wa,dp,Iy,Cy,c1=j(()=>{fe(),_r(),ge(),_e(),ni(),iu(),up=e=>{let t=1;for(let r=0;r<e.length;r++)t*=e[r];return t},_a=e=>typeof e=="number"?[e,e,e]:e,Ri=(e,t)=>t<=1?e:e+(e-1)*(t-1),lp=(e,t,r,i=1)=>{let n=Ri(t,i);return Math.floor((e[0]*(r-1)-r+n)/2)},wa=(e,t,r,i,n)=>{n==null&&(n=lp(e,t[0],i[0]));let s=[0,0,0,r];for(let a=0;a<3;a++)e[a]+2*n>=t[a]&&(s[a]=Math.trunc((e[a]-t[a]+2*n)/i[a]+1));return s},dp=(e,t,r,i,n,s,a,o,u,d)=>{let c,f,m,y;if(e==="VALID"&&(e=0),typeof e=="number"){c={top:e,bottom:e,left:e,right:e,front:e,back:e};let _=wa([t,r,i,1],[o,u,d],1,[n,s,a],e);f=_[0],m=_[1],y=_[2]}else if(Array.isArray(e)){if(!e.every((w,T,v)=>w===v[0]))throw Error(`Unsupported padding parameter: ${e}`);c={top:e[0],bottom:e[1],left:e[2],right:e[3],front:e[4],back:e[5]};let _=wa([t,r,i,1],[o,u,d],1,[n,s,a],e[0]);f=_[0],m=_[1],y=_[2]}else if(e==="SAME_UPPER"){f=Math.ceil(t/n),m=Math.ceil(r/s),y=Math.ceil(i/a);let _=(f-1)*n+o-t,w=(m-1)*s+u-r,T=(y-1)*a+d-i,v=Math.floor(_/2),b=_-v,C=Math.floor(w/2),S=w-C,I=Math.floor(T/2),z=T-I;c={top:C,bottom:S,left:I,right:z,front:v,back:b}}else throw Error(`Unknown padding parameter: ${e}`);return{padInfo:c,outDepth:f,outHeight:m,outWidth:y}},Iy=(e,t,r,i,n,s=!1,a="channelsLast")=>{let o,u,d,c,f;if(a==="channelsLast")[o,u,d,c,f]=e;else if(a==="channelsFirst")[o,f,u,d,c]=e;else throw new Error(`Unknown dataFormat ${a}`);let[m,,y,_,w]=t,[T,v,b]=_a(r),[C,S,I]=_a(i),z=Ri(y,C),A=Ri(_,S),x=Ri(w,I),{padInfo:W,outDepth:G,outHeight:ue,outWidth:re}=dp(n,u,d,c,T,v,b,z,A,x),ae=s?m*f:m,N=[0,0,0,0,0];return a==="channelsFirst"?N=[o,ae,G,ue,re]:a==="channelsLast"&&(N=[o,G,ue,re,ae]),{batchSize:o,dataFormat:a,inDepth:u,inHeight:d,inWidth:c,inChannels:f,outDepth:G,outHeight:ue,outWidth:re,outChannels:ae,padInfo:W,strideDepth:T,strideHeight:v,strideWidth:b,filterDepth:y,filterHeight:_,filterWidth:w,effectiveFilterDepth:z,effectiveFilterHeight:A,effectiveFilterWidth:x,dilationDepth:C,dilationHeight:S,dilationWidth:I,inShape:e,outShape:N,filterShape:t}},Cy=(e,t,r,i,n,s)=>{let a=s==="channelsLast";a?e[0].dims[3]:e[0].dims[1];let o=[64,1,1],u={x:r.map((T,v)=>v)},d=[Math.ceil(up(u.x.map(T=>r[T]))/o[0]),1,1];Ee("verbose",()=>`[conv3d_naive_webgpu] dispatch = ${d}`);let c=1,f=B.size(r),m=[{type:12,data:f},{type:12,data:i},{type:12,data:n},{type:12,data:t.strides},{type:12,data:t.dilations}];ei(t,m),m.push(...de(e[0].dims,e[1].dims));let y=["rank","rank"],_=e.length===3;_&&(m.push(...de(e[2].dims)),y.push("rank")),m.push(...de(r));let w=T=>{let v=[{name:"output_size",type:"u32"},{name:"filter_dims",type:"u32",length:i.length},{name:"pads",type:"u32",length:n.length},{name:"strides",type:"u32",length:t.strides.length},{name:"dilations",type:"u32",length:t.dilations.length}];ti(t,v);let b=1,C=Je(e[0].dataType),S=P("x",e[0].dataType,e[0].dims.length,c),I=P("W",e[1].dataType,e[1].dims.length,b),z=[S,I],A=se("result",e[0].dataType,r.length,b),x="";if(_){let ue=P("bias",e[2].dataType,e[2].dims.length,b);z.push(ue),x+=`
  ...
  }`};return{name:"GroupedConv",shaderCache:{hint:`${t.cacheKey}_${f}`,inputDependencies:_},getRunData:()=>({outputs:[{dims:i?i(r):r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(m/64)},programUniforms:y}),getShaderSource:w}},ky=(e,t,r,i)=>{let n=e.length>2,s=je(r[3]),a=je(r[2]),o=B.size(r)/s/a,u=[e[0].dims[0],e[0].dims[1],e[0].dims[2],e[0].dims[3]/s],d=[e[1].dims[0],e[1].dims[1],e[1].dims[2],e[1].dims[3]/s],c=[r[0],r[1],r[2],r[3]/s],f=[{type:12,data:o},{type:6,data:[t.strides[0],t.strides[1]]},{type:6,data:[t.pads[0],t.pads[1]]}];ei(t,f),f.push(...de(u,d,c));let m=(a-1)*t.strides[1]+d[1],y=_=>{let w=se("output",e[0].dataType,c.length,s),T=Je(w.type.tensor),v=Jr(t,w.type.value,T),b=P("x",e[0].dataType,u.length,s),C=P("w",e[1].dataType,d.length,s),S=[b,C];n&&S.push(P("b",e[2].dataType,e[2].dims,s));let I=n?"value += b[output_channel];":"",z=[{name:"output_size",type:"u32"},{name:"strides",type:"i32",length:2},{name:"pads",type:"i32",length:2}];return ti(t,z),`
  ${_.registerUniforms(z).declareVariables(...S,w)}
  ${_.mainStart()}
    ${_.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
...
`)};
    ...
    ${a.mainStart(bi)}
      ...
      ${d.setByOffset("global_idx",co("x_in"))}
        ...
        `;for(let I=0,z=0;I<n;I++)I===s?(S+=`${n>1?`dataIndices${b}[${I}]`:`dataIndices${b}`} = u32(idx${b});`,z+=C):(S+=`${n>1?`dataIndices${b}[${I}]`:`dataIndices${b}`} = ${a.length>1?`outputIndices${b}[${z}]`:`outputIndices${b}`};`,z++);return S},v;if(e[0].dataType===9){let b=(C,S,I="")=>`
  ...
  ${v.mainStart()}
    ...
    ${C}
    ${A!=null?`let cOffset = ${A.broadcastedIndicesToOffset("vec2(m, n)",W)}; value += ${z}(uniforms.beta) * ${A.getByOffset("cOffset")};`:""}
    output[global_idx] = value;
  }`},T=v=>{let b=P("a",e[0].dataType,e[0].dims),C=P("b",e[1].dataType,e[1].dims),S=null,I=[b,C];e.length===3&&(S=P("c",e[2].dataType,e[2].dims.length),I.push(S));let z=se("output",e[0].dataType,o.length);I.push(z);let A=[{name:"num_tile_n",type:"u32"},{name:"M",type:"u32"},{name:"N",type:"u32"},{name:"K",type:"u32"},{name:"alpha",type:"f32"},{name:"beta",type:"f32"}],x="",W="";t.transA&&t.transB?(W=`
...
`)}
  ...
  ${v.mainStart()}
    ...
    output[global_idx] = fma(input[global_idx], ${S(0)}, ${S(1)});
       ...
       Got scale size of ${f} and bias size of ${m}`);let y=[];for(let I=0;I<n.length;++I)I<u?y.push(n[I]):y.push(1);let _=je(c),w=["type","type"],T=[{type:12,data:d},{type:1,data:c},{type:12,data:Math.floor(c/_)},{type:1,data:t.epsilon}];a&&w.push("type");let v=r>1,b=r>2,C=I=>{let z=Je(e[0].dataType),A=[P("x",e[0].dataType,e[0].dims,_),P("scale",s.dataType,s.dims,_)];a&&A.push(P("bias",a.dataType,a.dims,_)),A.push(se("output",e[0].dataType,o,_)),v&&A.push(se("mean_data_output",1,y)),b&&A.push(se("inv_std_output",1,y));let x=[{name:"norm_count",type:"u32"},{name:"norm_size",type:"f32"},{name:"norm_size_vectorized",type:"u32"},{name:"epsilon",type:"f32"}];return`
  ...
  ${I.mainStart()}
    ...
    for (var j: u32 = 0; j < uniforms.norm_size_vectorized; j++) {
      let f32input = ${di(z,_,"x[j + offset]")};
      let f32scale = ${di(z,_,"scale[j]")};
    ...
    ${b?"inv_std_output[global_idx] = inv_std_dev":""};
  }`},S=[{dims:o,dataType:e[0].dataType}];return v&&S.push({dims:y,dataType:1}),b&&S.push({dims:y,dataType:1}),{name:"LayerNormalization",shaderCache:{hint:`${_};${r};${i}`,inputDependencies:w},getRunData:()=>({outputs:S,dispatchGroup:{x:Math.ceil(d/64)},programUniforms:T}),getShaderSource:C}},l0=(e,t)=>{lf(e.inputs),e.compute(df(e.inputs,t,e.outputCount))}}),cf,d0,z1=j(()=>{ge(),su(),au(),cf=e=>{if(!e||e.length!==2)throw new Error("MatMul requires 2 inputs.");if(e[0].dims[e[0].dims.length-1]!==e[1].dims[e[1].dims.length-2])throw new Error("shared dimension does not match.")},d0=e=>{cf(e.inputs);let t=wi.calcShape(e.inputs[0].dims,e.inputs[1].dims,!0);if(!t)throw new Error("Can't use matmul on the given tensors");let r=t[t.length-1],i=e.inputs[0].dims[e.inputs[0].dims.length-1];if(r<8&&i<8)e.compute(nu(e.inputs,{activation:""},t));else{let n=t[t.length-2],s=B.size(e.inputs[0].dims.slice(0,-2)),a=B.size(e.inputs[1].dims.slice(0,-2));if(s!==1&&n===1&&a===1){let o=e.inputs[0].reshape([1,s,i]),u=e.inputs[1].reshape([1,i,r]),d=[1,s,r],c=[o,u];e.compute(ss(c,{activation:""},t,d),{inputs:c})}else e.compute(ss(e.inputs,{activation:""},t))}}}),pf,ff,hf,c0,p0,A1=j(()=>{fe(),ge(),Ke(),_e(),pf=(e,t)=>{if(e.length<3||e.length>4)throw new Error("MatMulNBits requires 3 or 4 inputs");let r=e[0],i=r.dims.length;if(r.dims[i-1]!==t.k)throw new Error("The last dim of input shape does not match the k value");let n=Math.floor((t.k+t.blockSize-1)/t.blockSize),s=t.blockSize/8*t.bits,a=e[1];if(!B.areEqual(a.dims,[t.n,n,s]))throw new Error("The second inputs must be 3D tensor with shape N X nBlocksPerCol X blobSize");let o=e[2].dims;if(B.size(o)!==t.n*n)throw new Error("scales input size error.");if(e.length===4){let u=e[3].dims,d=t.n*(t.bits===8?n:Math.floor((n*t.bits+7)/8));if(B.size(u)!==d)throw new Error("zeroPoints input size error.")}},ff=(e,t)=>{let r=e[0].dims,i=r.length,n=r[i-2],s=t.k,a=t.n,o=r.slice(0,i-2),u=B.size(o),d=e[1].dims[2]/4,c=e[0].dataType,f=je(t.k),m=je(d),y=je(a),_=o.concat([n,a]),w=n>1&&a/y%2===0?2:1,T=B.size(_)/y/w,v=64,b=[],C=[u,n,s/f],S=B.convertShape(e[1].dims).slice();S.splice(-1,1,d/m),b.push(...de(C)),b.push(...de(S)),b.push(...de(e[2].dims)),e.length===4&&b.push(...de(B.convertShape(e[3].dims)));let I=[u,n,a/y];b.push(...de(I));let z=A=>{let x=C.length,W=P("a",e[0].dataType,x,f),G=P("b",12,S.length,m),ue=P("scales",e[2].dataType,e[2].dims.length),re=[W,G,ue],ae=e.length===4?P("zero_points",12,e[3].dims.length):void 0;ae&&re.push(ae);let N=I.length,L=se("output",e[0].dataType,N,y),Q=Je(e[0].dataType),te=(()=>{switch(f){case 1:return`array<${Q}, 8>`;case 2:return`mat4x2<${Q}>`;case 4:return`mat2x4<${Q}>`;default:throw new Error(`${f}-component is not supported.`)}})(),Z=()=>{let U=`
          // reuse a data
        ...
        }`};return{name:"MatMulNBits",shaderCache:{hint:`${t.blockSize};${t.bits};${f};${m};${y};${w};${v}`,inputDependencies:Array(e.length).fill("rank")},getRunData:()=>({outputs:[{dims:_,dataType:c}],dispatchGroup:{x:T},programUniforms:b}),getShaderSource:z}},hf=(e,t)=>{let r=e[0].dims,i=r.length,n=r[i-2],s=t.k,a=t.n,o=r.slice(0,i-2),u=B.size(o),d=e[1].dims[2]/4,c=e[0].dataType,f=je(t.k),m=je(d),y=o.concat([n,a]),_=128,w=a%8===0?8:a%4===0?4:1,T=_/w,v=T*m*8,b=v/f,C=v/t.blockSize,S=B.size(y)/w,I=[],z=[u,n,s/f],A=B.convertShape(e[1].dims).slice();A.splice(-1,1,d/m),I.push(...de(z)),I.push(...de(A)),I.push(...de(e[2].dims)),e.length===4&&I.push(...de(B.convertShape(e[3].dims)));let x=[u,n,a];I.push(...de(x));let W=G=>{let ue=z.length,re=P("a",e[0].dataType,ue,f),ae=P("b",12,A.length,m),N=P("scales",e[2].dataType,e[2].dims.length),L=[re,ae,N],Q=e.length===4?P("zero_points",12,e[3].dims.length):void 0;Q&&L.push(Q);let te=x.length,Z=se("output",e[0].dataType,te),le=Je(e[0].dataType),Te=()=>{switch(f){case 1:return`
    ...
    `,o="",u=P("x",t.dataType,t.dims.length),d=["rank"],[c,f,m,y,_]=za(s,n);return c.push(...de(t.dims,s)),{name:e,shaderCache:{hint:`${i.cacheKey};${m};${y};${_}`,inputDependencies:d},getRunData:()=>({outputs:[{dims:s,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(B.size(s)/64)},programUniforms:c}),getShaderSource:w=>Aa(w,u,t.dims.length,s.length,n,a,o,t.dataType===10?-65504:-1e5,f,m,y,_)}},_0=(e,t)=>{Bi(e.inputs),e.compute(Na("MaxPool",e.inputs[0],!1,t))},w0=e=>{let t=e.storage_order,r=e.dilations,i=Ra(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(i.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");let n={storageOrder:t,dilations:r,...i,cacheKey:""};return{...n,cacheKey:Sf(n)}},b0=e=>{let t=e.format;return{format:t,...Ba,cacheKey:t}},v0=(e,t)=>{Bi(e.inputs),e.compute(Na("GlobalMaxPool",e.inputs[0],!0,t))}}),Tf,If,$0,x0,M1=j(()=>{fe(),ge(),Ke(),_e(),Tf=(e,t)=>{if(e.length<2||e.length>3)throw new Error("DequantizeLinear requires 2 or 3 inputs.");if(e.length===3&&e[1].dims===e[2].dims)throw new Error("x-scale and x-zero-point must have the same shape.");if(e.length===3&&e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[0].dataType===6&&e.length>2)throw new Error("In the case of dequantizing int32 there is no zero point.");if(e[1].dims.length!==0&&e[1].dims.length!==1&&e[1].dims.length!==e[0].dims.length)throw new Error("scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.");if(e.length>2){if(e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==e[2].dims.length)throw new Error("scale and zero-point inputs must have the same rank.");if(!e[1].dims.map((r,i)=>r===e[2].dims[i]).reduce((r,i)=>r&&i,!0))throw new Error("scale and zero-point inputs must have the same shape.")}if(t.blockSize>0){if(e[1].dims.length===0||e[1].dims.length===1&&e[1].dims[0]===1)throw new Error("blockSize must be set only for block quantization.");if(!e[1].dims.map((n,s)=>s===t.axis||n===e[0].dims[s]).reduce((n,s)=>n&&s,!0))throw new Error("For block qunatization, scale input shape to match the input shape except for the axis");if(e[1].dims.length!==e[0].dims.length)throw new Error("For block qunatization the scale input rank must be the same as the x rank.");let r=e[0].dims[t.axis],i=e[1].dims[t.axis];if(t.blockSize<Math.ceil(r/i)||t.blockSize>Math.ceil(r/(i-1)-1))throw new Error("blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].")}},If=(e,t)=>{let r=B.normalizeAxis(t.axis,e[0].dims.length),i=e[0].dataType,n=i===3,s=e[0].dims,a=e[1].dataType,o=B.size(s),u=i===3||i===2,d=u?[Math.ceil(B.size(e[0].dims)/4)]:e[0].dims,c=e[1].dims,f=e.length>2?e[2]:void 0,m=f?u?[Math.ceil(B.size(f.dims)/4)]:f.dims:void 0,y=c.length===0||c.length===1&&c[0]===1,_=y===!1&&c.length===1,w=je(o),T=y&&(!u||w===4),v=T?w:1,b=T&&!u?w:1,C=P("input",u?12:i,d.length,b),S=P("scale",a,c.length),I=f?P("zero_point",u?12:i,m.length):void 0,z=se("output",a,s.length,v),A=[C,S];I&&A.push(I);let x=[d,c];f&&x.push(m);let W=[{type:12,data:o/v},{type:12,data:r},{type:12,data:t.blockSize},...de(...x,s)],G=ue=>{let re=[{name:"output_size",type:"u32"},{name:"axis",type:"u32"},{name:"block_size",type:"u32"}];return`
      ...
      }`};return{name:"Range",shaderCache:{hint:`${i}`},getShaderSource:u,getRunData:()=>({outputs:[{dims:s,dataType:i}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:o})}},S0=e=>{let t=0,r=0,i=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],r=e.inputs[1].getInt32Array()[0],i=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],r=e.inputs[1].getFloat32Array()[0],i=e.inputs[2].getFloat32Array()[0]),Ve.webgpu.validateInputContent&&Cf(t,r,i),e.compute(Ef(t,r,i,e.inputs[0].dataType),{inputs:[]})}}),kf,zf,T0,I0,N1=j(()=>{fe(),ge(),Ke(),_e(),kf=(e,t,r,i)=>{if(e!=="none"&&i!=="i32"&&i!=="u32"&&i!=="f32")throw new Error(`Input ${i} is not supported with reduction ${e}.`);let n=`{
                var oldValue = 0;
                loop {
                  let newValueF32 =`,s=`;
  ...
  for (var i = 0u; i < uniforms.num_updates_elements; i++) {
    ...
    ${kf(t.reduction,"output[data_offset + i]","value",_.type.value)}
      ...
      }`};return{name:"ScatterND",shaderCache:{hint:`${t.cacheKey}_${t.reduction}`,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:d}),getShaderSource:c}},T0=e=>Oe({reduction:e.reduction}),I0=(e,t)=>{e.compute(zf(e.inputs,t),{inputs:[e.inputs[1],e.inputs[2]],outputs:[]})}}),Af,Of,Rf,Da,Mf,Bf,Nf,Df,Pf,Uf,Lf,Wf,Pa,qf,Vf,Hf,Gf,Ff,C0,E0,D1=j(()=>{fe(),ge(),Ke(),_e(),Af=(e,t)=>{if(e.every(r=>r>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),e.length>0){if(t.mode==="linear"){if(!(e.length===2||e.length===3||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1||e.length===5&&e[0]===1&&e[1]===1))throw new Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
...
`}
      ...
      }`},S=[{dims:o,dataType:e[0].dataType}];return r>1&&S.push({dims:c,dataType:1}),r>2&&S.push({dims:c,dataType:1}),r>3&&S.push({dims:s,dataType:e[0].dataType}),{name:"SkipLayerNormalization",shaderCache:{hint:`${v};${y};${_};${w}`,inputDependencies:e.map((I,z)=>"type")},getShaderSource:C,getRunData:()=>({outputs:S,dispatchGroup:{x:Math.ceil(u/d)},programUniforms:b})}},k0=(e,t)=>{jf(e.inputs);let r=[0];e.outputCount>1&&r.push(-3),e.outputCount>2&&r.push(-3),e.outputCount>3&&r.push(3),e.compute(Kf(e.inputs,t,e.outputCount,!1),{outputs:r})}}),Qf,Ni,Zf,Ua,Yf,Xf,z0,A0,U1=j(()=>{fe(),ge(),Ke(),_e(),Qf=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");if(t.axes.length!==0){if(t.axes.length!==t.starts.length||t.axes.length!==t.ends.length)throw new Error("axes, starts and ends must have the same length")}else if(t.starts.length!==t.ends.length)throw new Error("starts and ends must have the same length");e.slice(1).forEach((r,i)=>{if(e[i+1].dataType!==6&&e[i+1].dataType!==7)throw new Error(`Input ${i} must be an array of int32 or int64`)})},Ni=(e,t)=>{let r=[];if(e.length>t)if(e[t].dataType===7)e[t].getBigInt64Array().forEach(i=>r.push(Number(i)));else if(e[t].dataType===6)e[t].getInt32Array().forEach(i=>r.push(Number(i)));else throw new Error(`Input ${t} must be an array of int32 or int64`);return r},Zf=(e,t)=>{if(e.length>1){let r=Ni(e,1),i=Ni(e,2),n=Ni(e,3);return n.length===0&&(n=[...Array(e[0].dims.length).keys()]),Oe({starts:r,ends:i,axes:n})}else return t},Ua=(e,t,r,i,n)=>{let s=e;return e<0&&(s+=r[i[t]]),n[t]<0?Math.max(0,Math.min(s,r[i[t]]-1)):Math.max(0,Math.min(s,r[i[t]]))},Yf=(e,t,r)=>`fn calculateInputIndices(output_indices: ${t.type.indices}) -> ${e.type.indices} {
          var input_indices: ${e.type.indices};
          var carry = 0u;
      ...
      }`;return{name:"Slice",shaderCache:{hint:`${u.length}_${a.length}_${s.length}`,inputDependencies:["rank"]},getShaderSource:T,getRunData:()=>({outputs:[c],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:w})}},z0=(e,t)=>{Qf(e.inputs,t);let r=Zf(e.inputs,t);e.compute(Xf(e.inputs,r),{inputs:[0]})},A0=e=>{let t=e.starts,r=e.ends,i=e.axes;return Oe({starts:t,ends:r,axes:i})}}),Jf,eh,O0,R0,L1=j(()=>{fe(),ge(),Ke(),Br(),_e(),Jf=e=>{if(!e||e.length!==1)throw new Error("Softmax op requires 1 input.")},eh=(e,t)=>{let r=e.inputs[0],i=r.dims,n=B.size(i),s=i.length,a=B.normalizeAxis(t.axis,s),o=a<i.length-1,u,d=[];o?(d=Array.from({length:s},(A,x)=>x),d[a]=s-1,d[s-1]=a,u=e.compute(Tt(r,d),{inputs:[r],outputs:[-1]})[0]):u=r;let c=u.dims,f=c[s-1],m=n/f,y=je(f),_=f/y,w=64;m===1&&(w=256);let T=(A,x)=>x===4?`max(max(${A}.x, ${A}.y), max(${A}.z, ${A}.w))`:x===2?`max(${A}.x, ${A}.y)`:x===3?`max(max(${A}.x, ${A}.y), ${A}.z)`:A,v=P("x",u.dataType,u.dims,y),b=se("result",u.dataType,u.dims,y),C=v.type.value,S=Je(u.dataType)==="f32"?`var threadMax = ${C}(-3.4028234663852886e+38f);`:`var threadMax = ${C}(-65504.0h);`,I=A=>`
